...
const Ev LF_GLYPH[LF_GLYPH_LEN] = {{.abs_time = MS(0), .ev_type = DRV_0},
...
const Ev SP_GLYPH[SP_GLYPH_LEN] = {{.abs_time = MS(0), .ev_type = DRV_0},
                                   {.abs_time = MS(100), .ev_type = END_GLYPH}};
...
const Ev N0_GLYPH[N0_GLYPH_LEN] = {{.abs_time = MS(0), .ev_type = DRV_0},
                                   {.abs_time = MS(100), .ev_type = END_GLYPH}};

#define N1_GLYPH_LEN 2
const Ev N1_GLYPH[N1_GLYPH_LEN] = {{.abs_time = MS(0), .ev_type = DRV_0},
                                   {.abs_time = MS(100), .ev_type = END_GLYPH}};

#define N2_GLYPH_LEN 2
const Ev N2_GLYPH[N2_GLYPH_LEN] = {{.abs_time = MS(0), .ev_type = DRV_0},
                                   {.abs_time = MS(100), .ev_type = END_GLYPH}};

#define N3_GLYPH_LEN 2
const Ev N3_GLYPH[N3_GLYPH_LEN] = {{.abs_time = MS(0), .ev_type = DRV_0},
                                   {.abs_time = MS(100), .ev_type = END_GLYPH}};

#define N4_GLYPH_LEN 2
const Ev N4_GLYPH[N4_GLYPH_LEN] = {{.abs_time = MS(0), .ev_type = DRV_0},
                                   {.abs_time = MS(100), .ev_type = END_GLYPH}};

#define N5_GLYPH_LEN 2
const Ev N5_GLYPH[N5_GLYPH_LEN] = {{.abs_time = MS(0), .ev_type = DRV_0},
                                   {.abs_time = MS(100), .ev_type = END_GLYPH}};

#define N6_GLYPH_LEN 2
const Ev N6_GLYPH[N6_GLYPH_LEN] = {{.abs_time = MS(0), .ev_type = DRV_0},
                                   {.abs_time = MS(100), .ev_type = END_GLYPH}};
...
const Ev LT_GLYPH[LT_GLYPH_LEN] = {{.abs_time = MS(0), .ev_type = DRV_0},
                                   {.abs_time = MS(100), .ev_type = END_GLYPH}};

#define EQ_GLYPH_LEN 2
const Ev EQ_GLYPH[EQ_GLYPH_LEN] = {{.abs_time = MS(0), .ev_type = DRV_0},
                                   {.abs_time = MS(100), .ev_type = END_GLYPH}};

#define GT_GLYPH_LEN 2
const Ev GT_GLYPH[GT_GLYPH_LEN] = {{.abs_time = MS(0), .ev_type = DRV_0},
                                   {.abs_time = MS(100), .ev_type = END_GLYPH}};
...
const Ev AT_GLYPH[AT_GLYPH_LEN] = {{.abs_time = MS(0), .ev_type = DRV_0},
                                   {.abs_time = MS(100), .ev_type = END_GLYPH}};
...
const Ev A_GLYPH[A_GLYPH_LEN] = {{.abs_time = MS(0), .ev_type = DRV_0},
                                 {.abs_time = MS(100), .ev_type = END_GLYPH}};

#define B_GLYPH_LEN 2
const Ev B_GLYPH[B_GLYPH_LEN] = {{.abs_time = MS(0), .ev_type = DRV_0},
                                 {.abs_time = MS(100), .ev_type = END_GLYPH}};

#define C_GLYPH_LEN 2
const Ev C_GLYPH[C_GLYPH_LEN] = {{.abs_time = MS(0), .ev_type = DRV_0},
                                 {.abs_time = MS(100), .ev_type = END_GLYPH}};

#define D_GLYPH_LEN 2
const Ev D_GLYPH[D_GLYPH_LEN] = {{.abs_time = MS(0), .ev_type = DRV_0},
                                 {.abs_time = MS(100), .ev_type = END_GLYPH}};

#define E_GLYPH_LEN 2
const Ev E_GLYPH[E_GLYPH_LEN] = {{.abs_time = MS(0), .ev_type = DRV_0},
                                 {.abs_time = MS(100), .ev_type = END_GLYPH}};

#define F_GLYPH_LEN 2
const Ev F_GLYPH[F_GLYPH_LEN] = {{.abs_time = MS(0), .ev_type = DRV_0},
                                 {.abs_time = MS(100), .ev_type = END_GLYPH}};

#define G_GLYPH_LEN 2
const Ev G_GLYPH[G_GLYPH_LEN] = {{.abs_time = MS(0), .ev_type = DRV_0},
                                 {.abs_time = MS(100), .ev_type = END_GLYPH}};

#define H_GLYPH_LEN 2
const Ev H_GLYPH[H_GLYPH_LEN] = {{.abs_time = MS(0), .ev_type = DRV_0},
                                 {.abs_time = MS(100), .ev_type = END_GLYPH}};

#define I_GLYPH_LEN 2
const Ev I_GLYPH[I_GLYPH_LEN] = {{.abs_time = MS(0), .ev_type = DRV_0},
                                 {.abs_time = MS(100), .ev_type = END_GLYPH}};

#define J_GLYPH_LEN 2
const Ev J_GLYPH[J_GLYPH_LEN] = {{.abs_time = MS(0), .ev_type = DRV_0},
                                 {.abs_time = MS(100), .ev_type = END_GLYPH}};

#define K_GLYPH_LEN 2
const Ev K_GLYPH[K_GLYPH_LEN] = {{.abs_time = MS(0), .ev_type = DRV_0},
                                 {.abs_time = MS(100), .ev_type = END_GLYPH}};

#define L_GLYPH_LEN 2
const Ev L_GLYPH[L_GLYPH_LEN] = {{.abs_time = MS(0), .ev_type = DRV_0},
                                 {.abs_time = MS(100), .ev_type = END_GLYPH}};

#define M_GLYPH_LEN 2
const Ev M_GLYPH[M_GLYPH_LEN] = {{.abs_time = MS(0), .ev_type = DRV_0},
                                 {.abs_time = MS(100), .ev_type = END_GLYPH}};

#define N_GLYPH_LEN 2
const Ev N_GLYPH[N_GLYPH_LEN] = {{.abs_time = MS(0), .ev_type = DRV_0},
                                 {.abs_time = MS(100), .ev_type = END_GLYPH}};

#define O_GLYPH_LEN 2
const Ev O_GLYPH[O_GLYPH_LEN] = {{.abs_time = MS(0), .ev_type = DRV_0},
                                 {.abs_time = MS(100), .ev_type = END_GLYPH}};

#define P_GLYPH_LEN 2
const Ev P_GLYPH[P_GLYPH_LEN] = {{.abs_time = MS(0), .ev_type = DRV_0},
                                 {.abs_time = MS(100), .ev_type = END_GLYPH}};

#define Q_GLYPH_LEN 2
const Ev Q_GLYPH[Q_GLYPH_LEN] = {{.abs_time = MS(0), .ev_type = DRV_0},
                                 {.abs_time = MS(100), .ev_type = END_GLYPH}};

#define R_GLYPH_LEN 2
const Ev R_GLYPH[R_GLYPH_LEN] = {{.abs_time = MS(0), .ev_type = DRV_0},
                                 {.abs_time = MS(100), .ev_type = END_GLYPH}};

#define S_GLYPH_LEN 2
const Ev S_GLYPH[S_GLYPH_LEN] = {{.abs_time = MS(0), .ev_type = DRV_0},
                                 {.abs_time = MS(100), .ev_type = END_GLYPH}};

#define T_GLYPH_LEN 2
const Ev T_GLYPH[T_GLYPH_LEN] = {{.abs_time = MS(0), .ev_type = DRV_0},
                                 {.abs_time = MS(100), .ev_type = END_GLYPH}};

#define U_GLYPH_LEN 2
const Ev U_GLYPH[U_GLYPH_LEN] = {{.abs_time = MS(0), .ev_type = DRV_0},
                                 {.abs_time = MS(100), .ev_type = END_GLYPH}};

#define V_GLYPH_LEN 2
const Ev V_GLYPH[V_GLYPH_LEN] = {{.abs_time = MS(0), .ev_type = DRV_0},
                                 {.abs_time = MS(100), .ev_type = END_GLYPH}};

#define W_GLYPH_LEN 2
const Ev W_GLYPH[W_GLYPH_LEN] = {{.abs_time = MS(0), .ev_type = DRV_0},
                                 {.abs_time = MS(100), .ev_type = END_GLYPH}};

#define X_GLYPH_LEN 2
const Ev X_GLYPH[X_GLYPH_LEN] = {{.abs_time = MS(0), .ev_type = DRV_0},
                                 {.abs_time = MS(100), .ev_type = END_GLYPH}};

#define Y_GLYPH_LEN 2
const Ev Y_GLYPH[Y_GLYPH_LEN] = {{.abs_time = MS(0), .ev_type = DRV_0},
                                 {.abs_time = MS(100), .ev_type = END_GLYPH}};

#define Z_GLYPH_LEN 2
const Ev Z_GLYPH[Z_GLYPH_LEN] = {{.abs_time = MS(0), .ev_type = DRV_0},
                                 {.abs_time = MS(100), .ev_type = END_GLYPH}};
