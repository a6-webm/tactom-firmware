...
const Ev B_GLYPH[B_GLYPH_LEN] = {
    ...
    {.abs_time = MS(0), .ev_type = GO_6},
    {.abs_time = MS(0), .ev_type = GO_7},
    {.abs_time = MS(0), .ev_type = GO_8},
    {.abs_time = MS(0), .ev_type = GO_9},
    {.abs_time = MS(0), .ev_type = GO_10},
    {.abs_time = MS(0), .ev_type = GO_11},
    {.abs_time = MS(0) + GLYPH_DELAY, .ev_type = END_GLYPH}};
